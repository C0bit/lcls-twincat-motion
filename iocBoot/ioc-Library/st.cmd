...
# Libraries:
#
#   LCLS General-jozamudi: * -> 0.0.0 (SLAC)
#   PMPS: * (SLAC - LCLS)
...
epicsEnvSet("ADS_MAX_PARAMS",   "1052")
...
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:Library,IDX=1")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:Library")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:Library,PROJECT=lcls-twincat-motion.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.14.1+0.g20d35b3.dirty,PLC_HOST=")

#   LCLS General-jozamudi: * -> 0.0.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:Library,DEPENDENCY=LCLS_General-jozamudi,VERSION=0.0.0,VENDOR=SLAC")
#   PMPS: * (SLAC - LCLS)
